var data= {
    chatinit:{
        title: ["Hello <span class='emoji'> &#128075;</span>","I am Mr. Chatbot","choose the category?"],
        options: ["News On the health","fever","cold"]
    },
    any_other_disease: {
        title:["Please select an option"],
        options:['Alzheimers','Bollywood','Web Series','Others'],
        url : {
    ...
    fever: {
        title:["Thanks for your response","Please Read the following preacutions"],
        options:['Dont go out','dont eat junk food','please follow prescribed medicine'],
        url : {
            
        }
    },
    electronics: {
        title:["Thanks for your response","Here are some preacutins  for you"],
        options:["Don't Go Out","Please be cool follow above preacutions","please use tablets mentioned ","drink hot water instead of cool water"],
        url : {
            more:"https://www.youtube.com/@webhub/videos",
            link:["#","#","#","#","#"]
        }
    ...
    cold: {
        title:["Thanks for your response","Here are some preacutins  for you"],
        options: ["Wash your hands frequently","Avoiding touching your face","Cleaning frequently used surfaces"],
        url : {
            more:"#",
            link:["#","https://www.youtube.com/@webhub/videos","https://www.youtube.com/@webhub/videos"]
        }
    },
    hollywood:{
        title: ["Thanks for your response","Here are some some preacutions"],
        options: ["making changes to your home environment ","cognitive stimulation therapy "],
        url: {
            more:"https://www.youtube.com/@webhub/videos",
            link:["#","#","#","#","#"]
        }
